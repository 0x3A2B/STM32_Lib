...
//修改说明
//V1.1 20160902
//修改MPU6500_ID为: MPU6500_ID1,MPU6500_ID2,因为9250可能有2种ID!!!
//////////////////////////////////////////////////////////////////////////////////
I2C_HandleTypeDef *mpu9255i2c;
//初始化MPU9250
//返回值:0,成功
//    其他,错误代码
void i2cinit(I2C_HandleTypeDef *tmp)
{
    mpu9255i2c = tmp;
}
...
{
    HAL_I2C_Mem_Write(mpu9255i2c, addr << 1, reg, I2C_MEMADD_SIZE_8BIT, buf, len, 100);
    return 0;
}
...
{
    HAL_I2C_Mem_Read(mpu9255i2c, addr<<1, reg, I2C_MEMADD_SIZE_8BIT, buf, len, 100);
    return 0;
}
...
{
    HAL_I2C_Mem_Write(mpu9255i2c, addr << 1, reg, I2C_MEMADD_SIZE_8BIT, &data, 1, 100);
    return 0;
}
...
{
    uint8_t buf;
    HAL_I2C_Mem_Read(mpu9255i2c, addr<<1, reg, I2C_MEMADD_SIZE_8BIT, &buf, 1, 100);
    return buf;
}
